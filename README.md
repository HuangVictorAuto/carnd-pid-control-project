...
The PID value was tuned manually by me. The intial value for Kp, Ki, Kd selected using trial and error method. 
First I set Ki and Kd values to zero and increase proportional term (Kp) until system reaches to oscillating behavior.I reache the Kp as 0.15. 
Then Kd was tuned to reduced oscillation.The Kd was reached to 3.
With the Kp=0.15,Ki=0.0,Kd=3.0, the car can already drive through the track in the simulator without problem.So the parameter was finaly chosen.
